...
Wraps the open-source **graphify** CLI (PyPI package `graphifyy`, by Safi Shamsi —
<https://github.com/Graphify-Labs/graphify>). pagar contributes the method, not the
tool: treat this skill as the operating manual for making a codebase navigable at
token cost instead of context cost. The method behind it is written up in
https://github.com/ridwanspace/pagar/blob/main/docs/09-graphify.md
in the pagar repo you copied this skill from.
